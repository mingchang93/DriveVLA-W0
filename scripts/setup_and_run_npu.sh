#!/usr/bin/env bash
#
# End-to-end NPU pipeline: data → train → infer
#
...
OUTPUT_DIR="$PROJECT_ROOT/logs/e2e_npu_${TIMESTAMP}"

echo "============================================"
echo "DriveVLA-W0 — End-to-End NPU Pipeline"
echo "============================================"
