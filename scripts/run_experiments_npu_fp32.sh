#!/usr/bin/env bash
#
# fp32 experiments on NPU: 100/200 steps
#
# Usage:
#   bash scripts/run_experiments_npu_fp32.sh
#
set -e
...
echo "============================================"
echo "NPU fp32 experiments — output: $OUTPUT_DIR"
echo "============================================"
...
echo ""
echo "============================================"
echo "All NPU fp32 experiments done. Results: $OUTPUT_DIR"
echo "============================================"