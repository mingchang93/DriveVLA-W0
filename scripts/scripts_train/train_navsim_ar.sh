...
# inference
#  torchrun --nproc_per_node=${NGPUS} inference/vla/inference_action_navsim_ar_vava.py \
#       --emu_hub logs/${EXP_NAME} \
#       --output_dir logs/${EXP_NAME}/json_output \
#       --test_data_pkl /sda1/shuyao_shang/VLA_Emu_Huawei/data/navsim/processed_data/meta/navsim_emu_vla_256_144_test_pre_1s.pkl \
