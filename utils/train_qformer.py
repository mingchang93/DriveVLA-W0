...
from emu3.mllm import Emu3Config, Emu3Tokenizer, Emu3ForCausalLM, Emu3MoE, Emu3MoEConfig, Emu3Pi0, Emu3Pi0Config, Emu3QFormer
...
def load_model(model_args, model_config, training_args):
    # 初始化 QFormer 模型
    model = Emu3QFormer(config=model_config, pretrain_vlm_path = model_args.model_name_or_path)
